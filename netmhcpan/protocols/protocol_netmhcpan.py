...
from ..constants import MAX_PEPTIDE_MODE_LENGTH, MIN_PEPTIDE_LENGTH, NETMHCPAN_REFERENCE_PANEL, PEPTIDE_LENGTHS
...
class ProtNetMHCpanPromiscuity(EMProtocol):
    ...
    def createOutputStep(self):
        ...
        if not os.path.isfile(tracebackPath):
            # No peptide met MIN_PEPTIDE_LENGTH: netmhcpanStep never ran the program.
            return
    ...
    def _validate(self):
        return netmhcpanPlugin.validateInstallation()
